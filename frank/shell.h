...
/**
 * struct passinfo - pseudo-arguements to pass to a function
 ...
 * @status: status of the last execve command
 * @cmd_buf: a pointer to cmd_buf, on if chaining
...
/**
 * struct builtin - struct containing builtin string and related function
